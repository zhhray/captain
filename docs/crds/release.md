...
Release CRD stores the release info of a helm charts. It should be noted especially that the fields `ChartData`, `ConfigData`, `HooksData` and `ManifestData` are base64 encoded.
